    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="item-card flex flex-row justify-between items-center flex-wrap gap-3">
                    <div class="flex flex-row items-center gap-x-5 flex-grow">
                        <img src="{{Storage::url($course->thumbnail)}}" alt="" class="rounded-2xl object-cover w-[150px] h-[150px]">
                        <div class="flex flex-col max-w-full">
                            <h3 class="text-indigo-950 text-xl font-bold max-w-[300px]">{{$course->name}}</h3>
                    ...
                    <div class="flex flex-row items-center gap-x-3 min-w-[150px]">
                        <a href="{{route('admin.courses.edit', $course)}}" class="font-bold py-2 px-4 bg-indigo-700 text-white rounded-full">
                            Edit Course
                        </a>
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        src="https://www.youtube.com/embed/{{$video->path_video}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        <div class="flex flex-col">
