            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div class="hidden md:flex flex-col">
                        ...
                        <span class="text-sm font-bold py-1 px-2 rounded-full bg-green-500 text-white">ACTIVE</span>
                        @else
                        <span class="text-sm font-bold py-1 px-2 rounded-full bg-orange-500 text-white">PENDING</span>
                        @endif
                    </div>
                    <div class="hidden md:flex flex-col">
