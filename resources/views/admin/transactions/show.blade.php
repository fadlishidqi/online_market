            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Subscribe Start At</p>
                        ...
                        <div>
                            ...
                            <span class="w-fit text-sm font-bold py-1 px-2 rounded-full bg-green-500 text-white">ACTIVE</span>
                            @else
                            <span class="w-fit text-sm font-bold py-1 px-2 rounded-full bg-orange-500 text-white">PENDING</span>
                            @endif
                        </div>  
                        <div class="">
